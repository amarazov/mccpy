...
- ### Второто контролно ще се проведе на 14.12.2016 от 18:15 часа. Ще е 45 мин. 80% от задачите ще са като първото.
...
- ### Срокът за [второто домашно] е до 16.11.2016
- ### Срокът за [първото домашно] e до 9.11.2016



## Курсова работа

### Курсовата работа трябва да бъде написана в групи от 3-ма до 5-ма. До 14.12.2016 трябва да предадете писмено предложение за темата.

Попълнете следните точки в предложението:

- Загланвие
- Участници (имена, факултетни номера, специалности, курс)
- Кратко описание на проблема
- Методи, с които ще се опитате да го изследвате
